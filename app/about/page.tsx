  ...
  return (
    <section className="relative bg-[#0F121C] p-6 flex items-center justify-center">
      ...
      <motion.div
        ...
        className="relative z-10 max-w-full bg-white/10 text-white p-6 md:p-10 rounded-xl shadow-2xl backdrop-blur-lg border border-white/20"
      >
        ...
        <p className="text-lg leading-relaxed text-gray-200 mb-4">
          ...
          Fame. But it&apos;s not just about the players — this is a launchpad
          for aspiring journalists, photographers, videographers, and football
          creatives of every kind.
        </p>

        <p className="text-lg leading-relaxed text-gray-200 mb-4">
          Built on the legacy of <strong>The Sports Xchange</strong> and
          <strong> NFLDraftScout.com</strong>, we&apos;ve helped launch the
          careers of NFL insiders like Kevin Demoff (Rams), Jay Glazer (FOX),
          Dane Brugler (The Athletic), Chad Reuter (NFL.com), and Rob Rang (FOX,
          CFL Scout).
        </p>

        <p className="text-lg leading-relaxed text-gray-200 mb-4">
          Publisher <strong>Frank Cooney</strong>, who&apos;s covered football
          since 1965 and was among the first to report on the NFL Draft in 1967,
