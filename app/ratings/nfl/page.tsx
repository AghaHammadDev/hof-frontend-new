...
const NFLPage = () => {
  ...
  const mockData = [
    ...
    { rank: 3, name: "Aaron Donald", pos: "DT", team: "Rams", rating: "98.2" },
    {
      rank: 4,
      name: "Travis Kelce",
      pos: "TE",
    ...
    { rank: 5, name: "Nick Bosa", pos: "DE", team: "49ers", rating: "97.5" },
    {
      rank: 6,
      name: "Lamar Jackson",
      pos: "QB",
    ...
    { rank: 11, name: "Josh Allen", pos: "QB", team: "Bills", rating: "95.7" },
    {
      rank: 12,
      name: "Davante Adams",
      pos: "WR",
    ...
    { rank: 22, name: "A.J. Brown", pos: "WR", team: "Eagles", rating: "92.5" },
    {
      rank: 23,
      name: "Maxx Crosby",
      pos: "DE",
    ...
    { rank: 25, name: "Fred Warner", pos: "LB", team: "49ers", rating: "91.8" },
    {
      rank: 26,
      name: "Jalen Hurts",
      pos: "QB",
    ...
    <div className="min-h-screen bg-[#0F121C] px-4 sm:px-6 py-12 text-white flex flex-col items-center">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-gray-300 text-sm sm:text-base">
          Explore elite professional football player rankings
        </p>
      </div>
