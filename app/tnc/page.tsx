...
export default function About() {
  return (
    <section
      className="relative bg-no-repeat bg-cover bg-center min-h-screen flex items-center justify-center px-4"
    ...
    >
      ...
      >
        ...
        <p className="text-lg leading-relaxed text-gray-200 mb-6">
          Whether you're an athlete, a student journalist, or a diehard fan —
          this is your home. We're building a living legacy of football through
          participation, storytelling, and scouting. From Friday night lights to
          Canton, Ohio — the journey is here.
        </p>

        <p className="text-lg leading-relaxed text-gray-300 text-center">
          📬 Want to join us as a player or contributor? <br />
